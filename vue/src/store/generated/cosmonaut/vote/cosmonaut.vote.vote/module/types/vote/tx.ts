...
const baseMsgRegisterName: object = { creator: "", name: "" };
...
const baseMsgVote: object = { creator: "", name: "" };
...
export class MsgClientImpl implements Msg {
  ...
  Vote(request: MsgVote): Promise<MsgVoteResponse> {
    ...
    const promise = this.rpc.request("cosmonaut.vote.vote.Msg", "Vote", data);
