...
import CosmonautVoteCosmonautVoteVote from './cosmonaut/vote/cosmonaut.vote.vote'
...
export default { 
  CosmonautVoteCosmonautVoteVote: load(CosmonautVoteCosmonautVoteVote, 'cosmonaut.vote.vote'),
